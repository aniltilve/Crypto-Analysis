...
df_btc['Log10_MVRV'] = np.log10(df_btc['CapMVRVCur'])
print(df_btc)
...
ax[0].scatter(df_btc['time'], df_btc['CapMVRVCur'], c=df_btc['Quantile Rank'], s=3, cmap='RdYlGn_r', zorder=3)

ax[0].scatter(
    df_btc['time'].iloc[-1], 
    df_btc['CapMVRVCur'].iloc[-1],
...
ax[0].legend(title='BTC - MVRV Ratio')
...
ax[1].set_ylim(0, 1)
ax[1].legend(title='Quantile Rank of MVRV Ratio')
